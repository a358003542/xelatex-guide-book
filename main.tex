...
\item[xelatex应用] 这部分讨论了xelatex的一些引用，比如：化学，tikz制图，幻灯片，试卷等。
...
mainmatter命令放在正文开始的前面，表示页码为阿拉伯数字开始计数。【书籍从前言到目录完结应该是罗马数字，当要引用一本书的内容时候，一般是书名然后P123，这个123就是123页的意思。所以作者请不要在前言部分长篇大论，最多就是关于本书内容的简要介绍和一些感谢之类的，因为假如你的前言部分有什么重要的信息别人要引用，会让别人有点不太好办。mainmatter之后如果有什么一般性的讨论，绪论，序论，引言都是可以的。】
...
只有在极个别的情况下不写上\verb+\left...\right+会在显示上没有问题，但一般都推荐带上，请看下面的讨论。
...
我对这块没有精力维护了，如果读者真的要学习TeX原生命令，推荐查阅\href{http://www.tug.org/utilities/plain/cseq.html}{这个网站} 和阅读高德纳写的 The TexBook。
